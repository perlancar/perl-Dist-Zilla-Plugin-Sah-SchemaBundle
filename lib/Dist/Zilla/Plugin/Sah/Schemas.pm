      ...
      CREATE_SCHEMAR:
        {
            ...
            my $rfile = Dist::Zilla::File::InMemory->new(
                ...
                content => join(
                    ...
                    "A Sah::SchemaR::* module is useful if a client wants to lookup the base type of a schema wihout having to do any extra resolving (as a schema can be based on another schema, and so on). Currently L<Perinci::Sub::Complete> uses this instead of repeatedly consulting Sah::Schema::* to reduce startup overhead when doing tab completion.\n\n",
                ),
            );
...
These are useful if a client wants to lookup the base type of a schema wihout
